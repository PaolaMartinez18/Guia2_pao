CREATE DATABASE coffeeshops_pao;
...
/*Ejercicio 2 guia 2*/
SELECT * FROM pedido
WHERE fecha_registro BETWEEN '2024-01-01' AND '2024-02-01';
...
WHERE precio_producto = (SELECT MAX(precio_producto) FROM producto);SSSSSSSSSSSSSSS
